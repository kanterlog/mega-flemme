    ...
    <body>
        <div class="chat-container">
            <div class="chat-header">
                <h1>🤖 Sylvie</h1>
                <p>Ton assistante IA personnelle • Google Workspace • IA Hybride</p>
            </div>
            ...
            <div class="chat-messages" id="chatMessages">
                <div class="message assistant">
                    ...
                    <div class="message-content">
                        <strong>Salut ! Je suis Sylvie, ton assistante IA personnelle.</strong><br><br>
                        Je peux t'aider avec :
                        <ul style="margin: 10px 0; padding-left: 20px;">
                            <li>📧 Tes emails Gmail</li>
                            <li>📅 Ton calendrier</li>
                            <li>✅ Tes tâches quotidiennes</li>
                            <li>📝 Tes notes et documents</li>
                            <li>📊 Tes fichiers et données</li>
                            <li>📁 Ton Drive</li>
                        </ul>
            ...
            <div class="chat-input">
                ...
                <div class="suggestions" id="suggestions">
                    <div class="suggestion" onclick="sendSuggestion('Vérifie mes emails')">📧 Mes emails</div>
                    <div class="suggestion" onclick="sendSuggestion('Crée une tâche')">✅ Nouvelle tâche</div>
                    <div class="suggestion" onclick="sendSuggestion('Montre mon calendrier')">� Mon planning</div>
                    <div class="suggestion" onclick="sendSuggestion('Organise mes fichiers')">📁 Mes fichiers</div>
                </div>
            </div>
        </div>
...
async def chat_with_sylvie(message: ChatMessage) -> ChatResponse:
    ...
    try:
        ...
        api_response = ChatResponse(
            ...
            metadata={}  # SylvieResponse n'a pas de metadata
        )
